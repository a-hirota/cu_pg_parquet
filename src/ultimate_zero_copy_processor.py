...
from .cudf_zero_copy_processor import CuDFZeroCopyProcessor
from .binary_parser import detect_pg_header_size
...
class UltimateZeroCopyProcessor:
    ...
    def process_postgresql_to_parquet_ultimate(
        ...
        **kwargs
        ...
        print("=== GPU並列パース開始 ===")
        # 安定性重視: 従来版パーサーを使用
        from .binary_parser import parse_binary_chunk_gpu
