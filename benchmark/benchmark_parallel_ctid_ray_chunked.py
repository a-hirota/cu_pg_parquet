...
def run_ray_parallel_benchmark_chunked(
    ...
    for chunk_idx in range(CHUNK_COUNT):
        ...
        rows_processed, processing_time = process_chunk_data(
    ...
    avg_copy_speed = chunk_data_size * CHUNK_COUNT / (1024*1024) / total_copy_time
    improvement_ratio = avg_copy_speed / baseline_speed
    
    print(f"  平均COPY速度       : {avg_copy_speed:.2f} MB/sec")
